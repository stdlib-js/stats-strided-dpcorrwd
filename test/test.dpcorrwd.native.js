...
var dpcorrwd = tryRequire( resolve( __dirname, './../lib/dpcorrwd.native.js' ) );
var opts = {
	'skip': ( dpcorrwd instanceof Error )
};
...
tape( 'the function has an arity of 5', opts, function test( t ) {
	t.strictEqual( dpcorrwd.length, 5, 'returns expected value' );
	t.end();
});
